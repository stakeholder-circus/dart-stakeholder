...
- Purpose: Portable schema-driven CLI lane with deterministic scheduler, renderer, and event-model behavior locally, with live-provider runtime still open for the eventual full program target.
